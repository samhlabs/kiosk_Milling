...
direct_commands = ['kwebhelper.py','omxplayergui.py','kwebhelper_set.py','omxplayer','gksudo','xterm','/media/PiShare/Git/kiosk_Milling/startOMX.sh','/media/PiShare/Git/kiosk_Milling/startCCOMX.sh','/media/PiShare/Git/kiosk_Milling/stopOMX.sh','/media/PiShare/Git/kiosk_Milling/volumeUp.sh','/media/PiShare/Git/kiosk_Milling/volumeDown.sh']
